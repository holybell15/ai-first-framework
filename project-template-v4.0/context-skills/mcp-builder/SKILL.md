---
name: mcp-builder
description: "Build MCP servers to let Claude access external APIs and services. Use this for: 幫我做一個 MCP server, 連接外部 API, 我要讓 Claude 可以呼叫這個服務, 建立工具讓 LLM 使用. Perfect for Python (FastMCP) or TypeScript (MCP SDK)."
...
**Recommended stack:**
- **Language**: TypeScript (high-quality SDK support and good compatibility. AI models excel at generating TypeScript due to broad usage, static typing, and good linting)
...
- **Best Practices**: Core guidelines for naming, responses, pagination, transport, security, error handling
