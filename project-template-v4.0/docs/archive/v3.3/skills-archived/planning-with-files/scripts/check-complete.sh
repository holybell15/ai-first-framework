...
if [ "$COMPLETE" -eq "$TOTAL" ] && [ "$TOTAL" -gt 0 ]; then
    ...
    echo "[planning-with-files] If the user has additional work, add new phases (Phase $((TOTAL+1)), etc.) to task_plan.md before starting. Do NOT create a new plan file."
else
