...
3. 【確認 Rollback 方案】git revert 腳本 or DB rollback script

4. 【快速 Review】新 session → Review Agent 執行 HF-01~06 清單
   🔴 Critical 還需 Security Agent 快速掃描

5. 【部署】Staging 冒煙測試通過後才上 Production

6. 【48hr 補件】更新 RS + Gate 文件 + hotfix_log.md 標記 ✅ 結案
```
